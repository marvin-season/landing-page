    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <Card>
        <CardHeader className="pb-2 flex flex-row items-center gap-2">
          ...
          <span className="text-sm font-medium text-muted-foreground">总市值</span>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2 flex flex-row items-center gap-2">
          ...
          <span className="text-sm font-medium text-muted-foreground">当日盈亏</span>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2 flex flex-row items-center gap-2">
          ...
          <span className="text-sm font-medium text-muted-foreground">累计盈亏</span>
        </CardHeader>
        <CardContent>
