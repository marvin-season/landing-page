...
export const useExperience = () => {
    ...
    const experiences: WorkExperience[] = [
        {
          company:
            t`Digital China · Tongming Lake Cloud & Innovation Research Institute · AI R&D Center`,
          ...
          projects: [
            {
              ...
              description:
                t`Enterprise-level AI application one-stop construction and management platform that fully integrates model, data, application, and computing power.`,
            ...
            },
            {
              title: t`AI PC`,
              description:
                t`Intelligent Q&A system based on large language models, supporting cloud-based DeepSeek free full-featured version or local DeepSeek lightweight version.`,
          ...
          projects: [
            {
              title: t`Jushihui`,
              description:
                t`E-commerce platform focused on providing users with excellent shopping experience.`,
          ...
          projects: [
            {
              ...
              description:
                t`Health management software providing health management services for users.`,
